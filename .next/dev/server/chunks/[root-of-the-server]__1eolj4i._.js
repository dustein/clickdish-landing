...
"[project]/src/lib/posts.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const POSTS_DIR = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'content/blog');
async function getAllPosts() {
    const files = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readdirSync(POSTS_DIR).filter((f)=>f.endsWith('.mdx'));
    return files.map((filename)=>{
        const slug = filename.replace('.mdx', '');
        const raw = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(POSTS_DIR, filename), 'utf-8');
        const { data } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gray$2d$matter$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(raw);
        return {
            slug,
            ...data
        };
...
async function getPostBySlug(slug) {
    const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(POSTS_DIR, `${slug}.mdx`);
    ...
    const { data, content } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gray$2d$matter$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(raw);
    return {
        slug,
        content,
        ...data
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$posts$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/posts.js [app-route] (ecmascript)");
;
async function sitemap() {
    const posts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$posts$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllPosts"])();
    return [
        {
        ...
        {
            url: 'https://www.clickdish.fit/blog',
            priority: 0.9,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1eolj4i._.js.map